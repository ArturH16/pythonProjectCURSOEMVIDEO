def metade(num=0,moeda5='R$',f=False):
    res = num / 2
    if f:
        return f'{moeda5}{res:.2f}'.replace('.', ',')
    return res



def dobro(num=0,moeda5='R$',f=False):
    res =  num * 2
    if f:
        return f'{moeda5}{res:.2f}'.replace('.', ',')
    return res
...
def aumentar(num=0,aumento=0,moeda5='R$',f=False):
...
def diminuir(num=0,diminuicao=0,moeda5='R$',f=False):
...
def moeda(num=0,moeda5='R$',f=False):
    if f:
        return f'{moeda5}{num:.2f}'.replace('.',',')
    return f'{num}'
